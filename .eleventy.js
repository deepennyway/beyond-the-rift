...
async function inky(src) {
  const story = (new inkjs.Compiler(src))
  const storyCompile = story.Compile();
  console.log(story);
  const Json = storyCompile.ToJson();
  return Json
}
...
module.exports = function (eleventyConfig) {
    ...
    eleventyConfig.addNunjucksAsyncShortcode("inky", inky)
    eleventyConfig.addJavaScriptFunction("inky", inky)
    eleventyConfig.addLiquidShortcode("inky", inky)
    ...
    eleventyConfig.addDataExtension("ink", contents => inky(contents)
    );
